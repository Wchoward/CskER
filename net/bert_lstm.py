...
class BertForSequenceClassificationLSTM(BertPreTrainedModel):
    ...
    def forward(
        ...
        sorted_batch, sorted_lengths, _, restoration_idx = sort_by_seq_lens(hidden_output, sequences_lengths)
...
class BertForSequenceClassificationCskLSTM(BertPreTrainedModel):
    def __init__(self, config, args):
        super().__init__(config)
        self.num_labels = config.num_labels
        self.args = args
